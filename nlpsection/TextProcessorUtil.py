...
#
# def validate_main(mainQuery, OperationsList, listOfTableName, listOfAttributes):
#     tablename = ''
#     columns = []
#     command = ''
#     functions = ""
...
#             table_found = True
#             tablename += sqlmapper[sqlsyntax]
#
#         if table_found and sematic_mean == 'column':
#             column_found = True
#             columns.append(sqlmapper[sqlsyntax])
#
#         if table_found and not command_found and sematic_mean == 'command':
#             command += sqlmapper[sqlsyntax]
#
#         if not function_found and sematic_mean == 'function':
#             functions += sqlmapper[sqlsyntax]
#             function_found = True
#             sq, sem = mainQuery[i - 1]
#             if function_found and sem == 'column' and columns.count(sqlmapper[sq]) > 0:
#                 columns.remove(sqlmapper[sq])
#                 functions += " " + sqlmapper[sq]
#
#         if not calculation_found and sematic_mean == 'calculation':
#             calculation_found = True
#             calculation += sqlmapper[sqlsyntax]
#
...
#
#             Query += sqlmapper[columnsqlsyntax] + " " + sqlmapper[operatorsqlsyntax] + " " + valuesqlsyntax + " " + \
#                      sqlmapper[logicalsyntax]
#
#     return Query
#
# def create_main_query(main_dict):
#     main_query = ''
#     functions = ''
#     # print(main_dict)
...
#
# def genarate_boundry_command(normalied_tokens,tagedDict):
#     boundryIndexs = {}
...
#     return tokens
#
# def separate_main_conditional(boundryIndex, commandIndex, tagger_list_norm):
#     mainQuery = ''
#     conditionalQuery = ''
...
#
# def main_query_tokens(mainQuery):
#     commands = []
#     tableNames = []
#     attributeName = []
#     functions = []
...
# def concat_query(conditional_validation, conditions ,GENARATED_SQL_QUERY, logicalObject, GENARATED_SQL_FUNCTION):
#
